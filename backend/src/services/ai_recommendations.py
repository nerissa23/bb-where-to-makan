...
def _build_prompt(
    ...
    lines: list[str] = [
        ...
        "",
        "IMPORTANT - Cuisine classification in Malaysia:",
        '"Malaysian cuisine" includes Malay, Malaysian Chinese, Malaysian Indian (Mamak),',
        "Nasi Kandar, Nyonya/Baba, and local fusion/Mamak/warung food.",
        "Only classify as non-Malaysian when the food is clearly foreign, e.g.",
        "mainland Chinese (authentic Beijing duck, dim sum specialist), authentic Japanese",
        "(not local-style), Korean BBQ, Italian fine dining, etc.",
        "A Chinese restaurant in Malaysia serving local-style Chinese food counts as Malaysian cuisine.",
        "",
        "IMPORTANT: Google Places provides generic types like 'restaurant' or 'cafe'.",
        "Use the restaurant NAME to infer the actual cuisine type(s).",
        "For example: 'Sushi Mentai' -> Japanese, 'Nasi Kandar Pelita' -> Malaysian,",
        "'Dôme Cafe' -> Western/Fusion/Cafe, 'BBQ Plaza' -> Thai BBQ.",
        "Then evaluate cuisine mood match based on your inference, NOT the generic types.",
        "",
        "Group constraints:",
